...
from tensorflow.keras.layers import Bidirectional,CuDNNGRU,CuDNNLSTM,GRU,LSTM,concatenate,Dense,Input,Embedding, GlobalAveragePooling1D
...
class Position_Embedding(Layer):
    ...
    def call(self, x):
        ...
        position_i = tf.math.cumsum(K.ones_like(x[:,:,0]), 1)-1 
...
class Attention(Layer):
    ...
    def __init__(self, nb_head = 8, size_per_head = 256, **kwargs):
...
#         print("\n\n\n\n", O_seq)
    ...
    def compute_output_shape(self, input_shape):
        return (input_shape[0].as_list()[0], input_shape[0].as_list()[1], self.output_dim) 
